...
import 'package:flutter_ui_store/screen/reserve/widget/choose_date.dart';
import 'package:flutter_ui_store/screen/reserve/widget/choose_time_group.dart';
import 'package:flutter_ui_store/screen/reserve/widget/my_appbar.dart';
import 'package:flutter_ui_store/screen/reserve/widget/user_info.dart';
    ...
    return Scaffold(
      body: Column(
        children: <Widget>[
          MyHeader(
            height: 258,
            imageUrl: 'assets/images/medical/avatar_head.png',
            child: Column(
              children: <Widget>[
                MyAppbar(),
                SizedBox(
